    ...
    <div class="mt-4">
        ...
        @csrf
            <div class="mt-3">
                ...
                <input type="email" name="username" autofocus="true" autocomplete="off" class="form-control" id="username" placeholder="Enter Email ..." required>
            ...
            <div class="mt-1">
                ...
                <div class="position-relative auth-pass-inputgroup show_hide_password">
                    <input type="password" name="password" autocomplete="off" class="form-control pe-5 password-input" id="password" placeholder="Enter Password ..." required>

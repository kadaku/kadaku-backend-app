...
<body style="width: 100%;height: 100%;font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif ;background-color: #eee;">
  <div class="container"> 
    ...
    <div class="card">
      ...
      <hr style="border-style: dashed;border-top: 0.9px;border-color: lightgray">
      <p style="font-size: 14px;margin-top:20px;">Please verify that you want to use this as your Kadaku account email address. Once it's done you will be able to start creating new invitation.</p>
      
      <a href="{{ isset($url) ? $url : '' }}" target="_blank" style="font-size: 14px;color: #ffffff; text-decoration: none; padding: 15px 25px; border-radius: 10px; background:#EC595A; display: inline-block;margin: 25px 0; outline: 0;">Confirm Account</a>
      ...
      <small style="font-size: 11px;color: gray;">
        If you're having trouble clicking the "Confirm Account" button, copy and paste the URL below into your web browser: <br>

		...
		<div class="modal-content">
			<form action="" id="form_add">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="type" class="validate">
					...
					$.ajax({
						...
						success: function(data) {
							if (data.validate == true) {
								...
								syamValidationServer('[name="type"]', 'type', data);
								return false;
							}
			...
			success: function(data) {
				...
				$.each(data.data.list, function(i, v) {
					...
					var html = '<tr>' +
						...
						'<td class="nowrap"><i class="icon ph-fill ' + v.icon + '" style="color: currentcolor; font-size: 50px;"></i></td>' +

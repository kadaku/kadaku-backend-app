            ...
            , E = function() {
              ...
              e.prototype._renderChoices = function() {
                  ...
                  i.length >= 1 && !this._isSearching) {
                      ...
                      o = this._createGroupsFragment(i, n, o)
                  } else
                      n.length >= 1 && (o = this._createChoicesFragment(n, o));
              ...
              e.prototype._createGroupsFragment = function(e, t, i) {
                  ...
                  e.forEach((function(e) {
                      ...
                      if (o.length >= 1) {
                          ...
                          i.appendChild(r),
                          n._createChoicesFragment(o, i, !0)
                      }
                  }
                  )),
                  i
              ...
              e.prototype._createItemsFragment = function(e, t) {
                  ...
                  return o && !this._isSelectOneElement && e.sort(r),
              ...
              e.prototype._onKeyDown = function(e) {
                  ...
                  switch (this._isTextElement || o || !a || (this.showDropdown(),
              ...
              e.prototype._onKeyUp = function(e) {
                  ...
                  if (this._isTextElement)
                      ...
                      this._store.dispatch((0,
                      a.activateChoices)(!0))) : p && this._handleSearch(this.input.value)
                  }
                  this._canSearch = this.config.searchEnabled
              }
              ,
              ...
              e.prototype._onEnterKey = function(e, t, i) {
                  ...
                  if (this._isTextElement && n && n.value) {
                      ...
                      this._canAddItem(t, s).response && (this.hideDropdown(!0),
                      this._addItem({
                          value: s
                      }),
              ...
              e.prototype._getTemplate = function(e) {
                  for (var t, i = [], o = 1; o < arguments.length; o++)
                      i[o - 1] = arguments[o];
            ...
            , o = function() {
              ...
              e.prototype._animateScroll = function(e, t) {
                  var i = this
                    ...
                    , s = !1;
                  t > 0 ? (this._scrollDown(r, o, e),
                  r < e && (s = !0)) : (this._scrollUp(r, o, e),
                  r > e && (s = !0)),
          ...
          t.default = function(e, n) {
              ...
              case "ADD_ITEM":
                  ...
                  return s.choiceId > -1 ? e.map((function(e) {
                      var t = e;
                      return t.id === parseInt("".concat(s.choiceId), 10) && (t.selected = !0),
                      t
                  }
                  )) : e;
              case "REMOVE_ITEM":
      ...
      744: function(e, t, i) {
          ...
          var r = i(857)
            ...
            , a = function() {
              function e() {
                  this._store = (0,
                  r.createStore)(s.default, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__())
              }
      ...
      686: function(e, t) {
          ...
          var i = {
              containerOuter: function(e, t, i, n, o, r) {
                  ...
                  return a.dataset.type = r,
                  t && (a.dir = t),
                  n && (a.tabIndex = 0),
                  i && (a.setAttribute("role", o ? "combobox" : "listbox"),
              ...
              itemList: function(e, t) {
                  var i = e.list
                    ...
                    , o = e.listItems;
                  return Object.assign(document.createElement("div"), {
                      className: "".concat(i, " ").concat(t ? n : o)
                  })
              },
              ...
              item: function(e, t, i) {
                  ...
                  i) {
                      p && v.classList.remove(s),
                      v.dataset.deletable = "";
                      var _ = "Remove item"
                        , g = Object.assign(document.createElement("button"), {
                          type: "button",
                          className: o,
                          innerHTML: _
                      });
                      g.setAttribute("aria-label", "".concat(_, ": '").concat(l, "'")),
                      g.dataset.button = "",
                      v.appendChild(g)
                  }
                  return v
              ...
              choiceGroup: function(e, t) {
                  var i = e.group
                    ...
                    , c = Object.assign(document.createElement("div"), {
                      className: "".concat(i, " ").concat(a ? o : "")
                  });
                  return c.setAttribute("role", "group"),
              ...
              choice: function(e, t, i) {
                  ...
                  _.setAttribute("aria-disabled", "true")) : (_.classList.add(r),
                  _.dataset.choiceSelectable = ""),
                  _
              },
              input: function(e, t) {
                  var i = e.input
              ...
              notice: function(e, t, i) {
                  ...
                  void 0 === i && (i = "");
                  var a = [n, o];
                  return "no-choices" === i ? a.push(s) : "no-results" === i && a.push(r),
              ...
              option: function(e) {
                  ...
                  return n && (s.dataset.customProperties = "".concat(n)),
                  s.disabled = !!r,
                  s
              }
          };
          ...
          function a(e, i, c) {
              ...
              return l === Array.isArray(e) ? l ? c.arrayMerge(e, i, c) : function(e, t, i) {
                  ...
                  r(t).forEach((function(r) {
                      ...
                      )(e, r) || (s(e, r) && i.isMergeableObject(t[r]) ? o[r] = function(e, t) {
                          if (!t.customMerge)
                              return a;
                          var i = t.customMerge(e);
                          return "function" == typeof i ? i : a
                      }(r, i)(e[r], t[r], i) : o[r] = n(t[r], i))
                  }
                  )),
                  o
              }(e, i, c) : n(i, c)
      ...
      70: function(e) {
                      ...
                      value: function(e, t) {
                          ...
                          if (null != r) {
                              ...
                              if ("string" == typeof r) {
                                  this._log("\nKey: ".concat("" === i ? "-" : i));
                                  var E = d.search(r);
                                  if (this._log('Full text: "'.concat(r, '", score: ').concat(E.score)),
                                  this.options.tokenize) {
                                      for (var b = r.split(this.options.tokenSeparator), S = [], I = 0; I < h.length; I += 1) {
                                          ...
                                          for (var C = !1, T = 0; T < b.length; T += 1) {
                                              var A = b[T]
                                                , L = O.search(A)
                                                , w = {};
                                              L.isMatch ? (w[A] = L.score,
                                              _ = !0,
                                              C = !0,
                                              S.push(L.score)) : (w[A] = 1,
                                      ...
                                      for (var P = S.length, D = 1; D < P; D += 1)
                                          g += S[D];
                                      g /= P,
                                      this._log("Token score average:", g)
                                  }
                                  var N = E.score;
                                  g > -1 && (N = (N + g) / 2),
                          ...
                          for (var i = 0, n = t.length; i < n; i += 1) {
                              for (var o = t[i].output, r = o.length, s = 1, a = 1, c = 0; c < r; c += 1) {
                                  var l = e ? e[o[c].key].weight : 1
                                    , h = (1 === l ? o[c].score : o[c].score || .001) * l;
                                  1 !== l ? a = Math.min(a, h) : (o[c].nScore = h,
                                  s *= h)
                              }
                              t[i].score = 1 === a ? s : a,
                              this._log(t[i])
                          ...
                          this.options.includeMatches && o.push((function(e, t) {
                              ...
                              for (var n = 0, o = i.length; n < o; n += 1) {
                                  ...
                                  if (0 !== r.matchedIndices.length) {
                                      ...
                                      r.key && (s.key = r.key),
                                      r.hasOwnProperty("arrayIndex") && r.arrayIndex > -1 && (s.arrayIndex = r.arrayIndex),
                                      t.matches.push(s)
                                  }
                              }
                          }
          ...
          , function(e, t, i) {
              ...
              e.exports = function(e, t, i, r) {
                  for (var s = r.location, a = void 0 === s ? 0 : s, c = r.distance, l = void 0 === c ? 100 : c, h = r.threshold, u = void 0 === h ? .6 : h, d = r.findAllMatches, p = void 0 !== d && d, f = r.minMatchCharLength, m = void 0 === f ? 1 : f, v = a, _ = e.length, g = u, y = e.indexOf(t, v), E = t.length, b = [], S = 0; S < _; S += 1)
                      b[S] = 0;
                  if (-1 !== y) {
                      var I = n(t, {
                          errors: 0,
          ...
          , function(e, t) {
              e.exports = function() {
                  for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, i = [], n = -1, o = -1, r = 0, s = e.length; r < s; r += 1) {
                      var a = e[r];
                      a && -1 === n ? n = r : a || -1 === n || ((o = r - 1) - n + 1 >= t && i.push([n, o]),
                      n = -1)
                  }
                      ...
                      if (i) {
                          ...
                          if (null != c)
                              if (a || "string" != typeof c && "number" != typeof c)
                                  if (n(c))
                                      for (var l = 0, h = c.length; l < h; l += 1)
                                          e(c[l], a, o);
                                  else
                                      a && e(c, a, o);
                              else

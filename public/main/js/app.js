! function() {
    ...
    }), document.getElementById("removeNotificationModal") && document.getElementById("removeNotificationModal").addEventListener("show.bs.modal", function(e) {
...
function clock() {
	...
	var Hari = '<i class="bx bx-calendar"></i>  ' + thisDay + ', ' + day + ' ' + months[month] + ' ' + year;
	//document.write();
	...
	// var Time = " - <i class='bx bx-time'></i> : " + hr + " : " + mins + " : " + secs + " WIB";
	var Time = " <i class='bx bx-time'></i> : " + hr + " : " + mins + " : " + secs;
	document.getElementById("live-clock").innerHTML = Hari + Time + ' WIB';
	requestAnimationFrame(clock);
}